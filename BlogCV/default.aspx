<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="BlogCV._default" %>
...
<head>
    ...
    <title>STORYMEDYA.COM / CV TEMPLATE</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#skills">YETENEKELR</a>
                </li>
                <li class="nav-item">
