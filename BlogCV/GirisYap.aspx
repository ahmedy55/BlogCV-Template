<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GirisYap.aspx.cs" Inherits="BlogCV.GirisYap" %>
                ...
                <div class="card-body">
                    <form runat="server">
                        ...
                        <div class="form-group">
                            <asp:Button ID="Button1" runat="server" Text="Giris Yap" Cssclass="btn float-right login_btn" OnClick="Button1_Click"/>
